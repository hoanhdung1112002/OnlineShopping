...
class FrontendController extends Controller
{
    ...
    public function home(){
        $featured=Product::where('status','active')->where('is_featured',1)->orderBy('price','DESC')->limit(5)->get();
        $posts=Post::where('status','active')->orderBy('id','DESC')->limit(3)->get();
        $banners=Banner::where('status','active')->limit(3)->orderBy('id','DESC')->get();
        $brands=Brand::where('status','active')->get();
        // return $banner;
        $products=Product::where('status','active')->orderBy('id','DESC')->limit(5)->get();
        $newproduct=Product::where('status','active')->where('condition','new')->orderBy('id','DESC')->limit(5)->get();
