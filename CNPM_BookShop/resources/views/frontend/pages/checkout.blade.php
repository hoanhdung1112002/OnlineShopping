                    ...
                    <div class="row">
                        <div class="col-lg-8 col-md-6">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                                        <p>Họ<span>*</span></p>
                                        <input type="text" name="first_name" style="color:#333">
                                    </div>
                                </div>
                                <div class="col-lg-6">
                                    <div class="checkout__input">
                                        <p>Tên<span>*</span></p>
                                        <input type="text" name="last_name" style="color:#333">
                                    </div>
                                </div>
                            </div>
                            <div class="checkout__input">
                            ...
                            {{-- <div class="checkout__input">
                                ...
                                <input type="text" name="address2" placeholder="Có thể để trống...">
                            </div> --}}
                            <div class="checkout__input">
                                ...
                                <div class="checkout__input__checkbox">
                                    <label for="payment">
                                       Thanh toán khi nhận hàng
                                        <input type="radio" id="payment" name="payment_method" value="Thanh toán khi nhận hàng">
